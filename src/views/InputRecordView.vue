<template>
    <div>
        ...
        <el-table :data="tableData" stripe style="width: 100%">
            <el-table-column prop="irId" label="入库编号" width="180">
            </el-table-column>
            <el-table-column prop="mid" label="物料编号">
            </el-table-column>
            <el-table-column prop="irCount" label="入库数量">
            </el-table-column>
            <el-table-column prop="waId" label="入库库区编号" width="180">
            </el-table-column>
            <el-table-column prop="irTime" label="入库时间">
            </el-table-column>
